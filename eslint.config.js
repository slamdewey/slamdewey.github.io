...
export default defineConfig([
  ...
  },
  {
    ...
    rules: {
      ...
      '@angular-eslint/directive-selector': ['error', { type: 'attribute', prefix: 'x', style: 'camelCase' }],
      '@angular-eslint/component-selector': ['error', { type: 'element', prefix: 'x', style: 'kebab-case' }],
      'no-unused-vars': 'off',
